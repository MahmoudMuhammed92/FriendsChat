package com.example.sahil.friendschat.Adapter;
...
import com.example.sahil.friendschat.R;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            ...
            else
            {
                ...
                BubbleTextView bubbleTextView = (BubbleTextView) view.findViewById(R.id.message_content);
                bubbleTextView.setText(qbChatMessages.get(position).getBody());
                TextView texName = (TextView)view.findViewById(R.id.message_user);
                texName.setText(QBUsersHolder.getInstance().getUserById(qbChatMessages.get(position).getSenderId()).getFullName());
            }
        }
        return  view;
    }
